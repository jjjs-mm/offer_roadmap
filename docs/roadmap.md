...
| 地域 | **南京优先**（要上课，通勤成本必须低） | **必须放开**（agent 核心团队在北京/杭州/深圳/上海） |
...
**这一阶段的地域策略要反转**：暑期实习不要再限南京，agent 核心团队在北京、杭州、深圳、上海。暑期是完整的两三个月，异地成本远低于日常实习。
...
| 暑期实习 | 2027 年 2 月底 – 4 月中 | **地域放开**，正面投 agent infra 岗，有实习经历就开启即投 |
